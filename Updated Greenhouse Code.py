...
for counter in range(12):
    difference_temperature_array.append(greenhouse_inside_temperature_array[counter] - outside_temperature_array[counter])
...
for months_counter in range(len(difference_temperature_array)):
    Qgreenhouse_single_layer_poly_ethylene_cover.append(Qgreenhouse_list(0, months_counter, 0, single_layer_poly_ethylene_array))
    Qgreenhouse_double_layer_poly_ethylene_cover.append(Qgreenhouse_list(1, months_counter, 1, double_layer_poly_ethylene_array))
    Qgreenhouse_single_layer_horti_cultural_cover.append(Qgreenhouse_list(2, months_counter, 2, single_layer_horti_cultural_array))
    Qgreenhouse_double_layer_horti_cultural_cover.append(Qgreenhouse_list(3, months_counter, 3, double_layer_horti_cultural_array))
    Qgreenhouse_single_layer_poly_carbonate_cover.append(Qgreenhouse_list(4, months_counter, 4, single_layer_poly_carbonate_array))
    Qgreenhouse_double_layer_poly_carbonate_cover.append(Qgreenhouse_list(5, months_counter, 5, double_layer_poly_carbonate_array))
    Qgreenhouse_single_layer_poly_vinyl_chloride_cover.append(Qgreenhouse_list(6, months_counter, 6, single_layer_poly_vinyl_chloride_array))
    Qgreenhouse_double_layer_poly_vinyl_chloride_cover.append(Qgreenhouse_list(7, months_counter, 7, double_layer_poly_vinyl_chloride_array))

Qgreenhouse_single_layer_poly_ethylene_cover = write_string_instead_of_0(Qgreenhouse_single_layer_poly_ethylene_cover, "Isıtma yapılmayacaktır.")
Qgreenhouse_double_layer_poly_ethylene_cover = write_string_instead_of_0(Qgreenhouse_double_layer_poly_ethylene_cover, "Isıtma yapılmayacaktır.")
Qgreenhouse_single_layer_horti_cultural_cover = write_string_instead_of_0(Qgreenhouse_single_layer_horti_cultural_cover, "Isıtma yapılmayacaktır.")
Qgreenhouse_double_layer_horti_cultural_cover = write_string_instead_of_0(Qgreenhouse_double_layer_horti_cultural_cover, "Isıtma yapılmayacaktır.")
Qgreenhouse_single_layer_poly_carbonate_cover = write_string_instead_of_0(Qgreenhouse_single_layer_poly_carbonate_cover, "Isıtma yapılmayacaktır.")
Qgreenhouse_double_layer_poly_carbonate_cover = write_string_instead_of_0(Qgreenhouse_double_layer_poly_carbonate_cover, "Isıtma yapılmayacaktır.")
Qgreenhouse_single_layer_poly_vinyl_chloride_cover = write_string_instead_of_0(Qgreenhouse_single_layer_poly_vinyl_chloride_cover, "Isıtma yapılmayacaktır.")
Qgreenhouse_double_layer_poly_vinyl_chloride_cover = write_string_instead_of_0(Qgreenhouse_double_layer_poly_vinyl_chloride_cover, "Isıtma yapılmayacaktır.")
